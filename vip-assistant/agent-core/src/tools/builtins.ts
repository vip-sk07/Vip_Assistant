...
let promptUserApproval: (toolName: string, input: any) => Promise<{ granted: boolean, reason?: string }> = async () => ({ granted: true });

export function setPermissionPromptHandler(handler: typeof promptUserApproval) {
